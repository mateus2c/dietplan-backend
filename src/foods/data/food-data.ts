...
// List of valid food IDs for validation
export const VALID_FOOD_IDS = FOOD_DATA.map((food) => food.id);

// Helper function to get food data by ID
export function getFoodData(foodId: string): FoodData | undefined {
